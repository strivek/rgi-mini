require(["jquery","yan/TweenLite.min","yan/EasePack.min"], function () {
    (function() {
        ...
        function initHeader() {
            ...
            // create points
            points = [];
            for(var x = 0; x < width; x = x + width/4) {
            ...
            for(var i in points) {
                var c = new Circle(points[i], 2+Math.random(), 'rgba(255,255,255,0.3)');
                points[i].circle = c;
            }
        }
